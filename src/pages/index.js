          ...
          <div className="row">
            <div className="col-xl-9 mx-auto">
              <div className="cta-inner text-center rounded">
                ...
                <p className="mb-0">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                  Pellentesque malesuada ac augue eget ultricies. Pellentesque
                  non auctor erat, sed bibendum elit. Donec sollicitudin libero
                  eu magna eleifend, at commodo dui pulvinar. Vivamus vulputate
                  libero a pharetra rhoncus.
                </p>
              </div>
            </div>
