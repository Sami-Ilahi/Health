          ...
          <div className="product-item-description d-flex mr-auto">
            <div className="bg-faded p-5 rounded">
              <p className="mb-0">
                ...
                rhoncus dapibus nibh, quis laoreet dui. Aliquam porta sit amet
                risus ac eleifend. In ornare ultrices enim, vel tincidunt justo
                fermentum sed. Curabitur et nulla lorem. Suspendisse consectetur
                felis ut placerat sodales.
              </p>
            </div>
          </div>
        </div>
